          ...
          <form className='flex flex-wrap w-full items-center justify-between'>
            <div className='w-1/2'>
              <div>
                ...
                <input className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400 mb-4' type="text"  placeholder='Name your UI Design'/>
              </div>
              <div>
            ...
            <div className='w-2/5 flex flex-col items-start'>
              ...
              <textarea className='text-sm py-1 px-2 w-4/5 rounded outline-none bg-transparent border-[1px] border-gray-400' name="" id="" cols={50} rows={10}></textarea>
